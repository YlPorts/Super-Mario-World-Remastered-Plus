...
func _enter_tree():
	...
	dock.plugin = self
	add_control_to_bottom_panel(dock, "Asset Drawer")
...
func _handles(object: Object) -> bool:
	return is_instance_valid(paint_mode) and paint_mode.enabled and object is CanvasItem

func _edit(object: Object) -> void:
	if is_instance_valid(paint_mode):
		paint_mode.edited_node = object

func _forward_canvas_gui_input(event: InputEvent) -> bool:
	return is_instance_valid(paint_mode) and paint_mode.paint_input(event)
